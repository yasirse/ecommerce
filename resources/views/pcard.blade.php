...
<div class="box-wrapper border border-gray-300 sm:w-1/2 sm:h-4/5 sm:p-10 relative w-full h-full">
    ...
    <!-- card section-->
    <div class="card bg-white w-full h-full rounded-2xl flex flex-wrap  shadow-theme-1 overflow-hidden p-5 sm:p-0">
       <!-- left side-->
       {{--  <div class="left-side  bg-gradient-to-tr from-theme-pink to-theme-blue w-full   rounded-2xl scale-105 shadow-theme-2">
            ...
            <div class="number absolute right-0 sm:-right-10 top-0 mt-8 bg-gradient bg-gradient-to-bl from-theme-blue to-theme-pink text-transparent bg-clip-text text-shadow">
        ...
        <!-- right side-->
,       {{-- <div class="right-side   bg-orange-300 w-full ">
            <div class="tex-logo flex justify-end ">
                <img src="/images/text-logo.png" alt="" >
            </div>
            <div class="price">
                <span class="font-bold text-3xl text-gray-600">$99</span>
        ...
        --}}
        <div class="yasir w-full bg-green-100"><p>fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff</p></div>
        <div class="yasir w-full bg-black-100">gghhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhf</div>
    </div> 
